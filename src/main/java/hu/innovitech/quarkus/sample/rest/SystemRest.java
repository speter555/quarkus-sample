...
import hu.innovitech.quarkus.sample.action.versioninfo.VersionInfoAction;

import jakarta.inject.Inject;

/**
 * Implementation of REST endpoint for system service functions.
 *
 * @author speter555
 * @since 0.1.0
 */
public class SystemRest extends BaseRestService implements ISystemRest {
    ...
    @Inject
    VersionInfoAction versionInfoAction;

    @Override
    public String versionInfo() throws BaseException {
        return wrapNoParam(versionInfoAction::versionInfo, "versionInfo");
    }
}
